...
package com.cashman.physio.v1.android.facebook;
...
public class Facebook {
	...
	private boolean validateAppSignatureForIntent(final Activity activity,
		...
		final ResolveInfo resolveInfo = activity.getPackageManager()
	 ...
	 *         ("true" if successful)
	 */
	public String logout(final Context context) throws MalformedURLException,
			IOException {
	 ...
	 */
	public String request(final Bundle parameters)
	 ...
	 * @return JSON string representation of the response
	 */
	public String request(final String graphPath) throws MalformedURLException,
			IOException {
	 ...
	 * @return JSON string representation of the response
	 */
	public String request(final String graphPath, final Bundle parameters)
			throws MalformedURLException, IOException {
	 ...
	 * @return JSON string representation of the response
	 */
	public String request(final String graphPath, final Bundle params,
			final String httpMethod) throws FileNotFoundException,
			MalformedURLException, IOException {
		params.putString("format", "json");
		if (isSessionValid()) {
			params.putString(TOKEN, getAccessToken());
		}
		final String url = graphPath != null ? GRAPH_BASE_URL + graphPath
				: RESTSERVER_URL;
	 ...
	 *            has completed.
	 */
	public void dialog(final Context context, final String action,
			final DialogListener listener) {
